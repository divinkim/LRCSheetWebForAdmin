                        ...
                        formElements.map((element) => (
                            <div className="text-gray-700 w-full space-y-4 md:space-y-0 items-center">
                                <div className="flex justify-between flex-wrap">
                                    <h1 className="font-bold mb-3 text-[20px] dark:text-gray-300 text-gray-700">Ajouter un nouveau poste</h1>
                                    <p className="text-blue-700 dark:text-blue-600">Dashboard/RH/Ajouter un poste</p>
                                </div>
                                        ...
                                        <div className={cn('w-full mb-4')}>
                                            ...
                                            {!e.selectedInput && !e.textarea ?
                                                <input value={inputs[e.alias] ?? ""} onChange={async (v) => {
                                                    ...
                                                    window?.localStorage.setItem("inputMemoryOfAddPostPage", JSON.stringify({ ...inputs, [field]: v.target.value }));
                                                ...
                                                e.selectedInput && !e.textarea ?
                                                    <select value={inputs[e.alias] ?? ""} onChange={(v) => {
                                                        ...
                                                        localStorage.setItem("inputMemoryOfAddPostPage", JSON.stringify(fieldValue))
